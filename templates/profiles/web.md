...
- 腳本存到 .4x/run/{feature-id}/e2e/，檔名用描述性名稱如 run-feature.spec.ts
- 截圖存到 settings.json 的 tester.screenshot_dir 指定路徑（預設 .4x/run/{feature-id}/e2e/screenshots/round-{round}/），檔名格式 {step}-{description}.png（如 01-dashboard-loaded.png）
