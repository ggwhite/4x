# 4x — Multi-Role AI Development Loop (Antigravity CLI Developer Guide)

This guide is for developers using the Antigravity CLI (`agy`) to build and maintain the 4x codebase.
...
plugins/
  ...
  agy/               Antigravity CLI instructions (AGY.md) and runner readme
