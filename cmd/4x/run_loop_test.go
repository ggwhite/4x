...
func TestRunLoop_HappyPath(t *testing.T) {
	...
	if err := runLoop(ws, ws, feature, cfg, s, func(string, string) runner.Runner { return mock }, "never"); err != nil {
...
func TestRunLoop_WorktreeSync(t *testing.T) {
	...
	if err := runLoop(mainWs, wtWs, feature, cfg, s, func(string, string) runner.Runner { return mock }, "never"); err != nil {
		t.Fatalf("runLoop error: %v", err)
	}
...
func TestRunLoop_MergedConfig(t *testing.T) {
	...
	if err := runLoop(ws, ws, feature, merged, s, func(string, string) runner.Runner { return mock }, "never"); err != nil {
