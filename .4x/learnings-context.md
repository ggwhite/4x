...
- 新增 guard 邏輯時，既有測試的資料 fixture 與 mock runner 輸出都要同步更新——fixture 補上新欄位（如 VerifyEvidence 的 ACResults），mock runner 補上新 guard 會寫出的檔案（如 build-gate.json）——否則既有測試會走進非預期錯誤路徑或靜默失敗，難以定位。
